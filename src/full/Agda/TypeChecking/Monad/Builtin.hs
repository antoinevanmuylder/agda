...
primInteger, primIntegerPos, primIntegerNegSuc,
    ...
    primMHComp, primMComp, primTestPrim, primReflectMCstr, primPrsvMCstr, primAllMCstr, primAllMCstrCounit, primRefoldMhocom,
...
primBridgeInterval                    = getBuiltin builtinBridgeInterval
primBIZero                            = getBuiltin builtinBIZero
primBIOne                             = getBuiltin builtinBIOne
...
prim_ungel                            = getPrimitiveTerm builtin_ungel
primCstrUniv                          = getBuiltin builtinCstrUniv
primBCstr                             = getBuiltin builtinBCstr
primBno                               = getPrimitiveTerm builtinBno
primByes                              = getPrimitiveTerm builtinByes
primBiszero                           = getPrimitiveTerm builtinBiszero
primBisone                            = getPrimitiveTerm builtinBisone
